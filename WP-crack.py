...
if len(sys.argv) <= 1:
    os.system('clear')
    print '\033[2;37;37mWP-crack v1.0 - a very fast logon WordPress Cracker'
    print '\033[2;37;37mWebsite: http://learntosharing.eu5.org'
    print 'Mail   : 7januarylts@gmail.com'
    print ''
...
print 'WP-crack 1.0 - a very fast logon WordPress Cracker'
print 'Website: http://learntosharing.eu5.org'
print 'Mail   : 7januarylts@gmail.com'
